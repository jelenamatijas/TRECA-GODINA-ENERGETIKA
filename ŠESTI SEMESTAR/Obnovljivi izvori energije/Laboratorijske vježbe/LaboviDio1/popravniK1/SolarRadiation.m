...
SolarConstant = 1377; % W/m2
I0 = SolarConstant*(1+0.034*cos(2*pi*nDay/365));
...
DirectRadiation = Ib*(cos(SunAltitude*pi/180)*cos(SolarAzimuthAngle*pi/180-CollectorAzimuthAngle*pi/180)*sin(TiltAngle*pi/180)+sin(SunAltitude*pi/180)*cos(TiltAngle*pi/180));
DiffuseRadiation = C*Ib*(1+cos(TiltAngle*pi/180))/2;
ExtraterrestrialRadiation = I0*(cos(SunAltitude*pi/180)*cos(SolarAzimuthAngle*pi/180-CollectorAzimuthAngle*pi/180)*sin(TiltAngle*pi/180)+sin(SunAltitude*pi/180)*cos(TiltAngle*pi/180));
