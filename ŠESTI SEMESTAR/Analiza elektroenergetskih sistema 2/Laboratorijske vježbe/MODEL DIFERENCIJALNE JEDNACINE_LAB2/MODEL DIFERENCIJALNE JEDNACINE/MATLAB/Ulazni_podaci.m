...
Ti   = 5;           % Vremenska konstanta inercije agregata u [s]
H    = Ti/2;
E    = 132.715;       % Vrijednost modula tranzijentne EMS generatora u [kV]
Umbs = 108.999;         % Vrijednost modula napona MBS u [kV]
...
pm     = 0.9000;    % Mehanicka snaga turbine u [r.j.]
pemax  = 1.6090;    % Maksimalna elektricna snaga koju generator ...
                    % isporucuje prije kvara u [r.j.]
pekmax = 0.9275;    % Maksimalna elektricna snaga koju generator ...
                    % isporucuje za vrijeme kvara u [r.j.]
peimax = 1.3750;    % Maksimalna elektricna snaga koju generator ...
                    % isporucuje poslije iskljucenja kvara u [r.j.]

% PODACI O KVARU

tf  = 0.150;        % Trenutak u kom nastaje kvara u [s]
tcl = 0.500;        % Trenutak u kom se otklanja kvar [s]

% PODACI O PRIGUSNOM NAMOTAJU

PD = 0.00;         % Modelovanje efekta prigusnog namotaja
